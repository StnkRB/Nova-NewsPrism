# Breaking the Echo Chamber: Building NewsPrism with Amazon Nova
...
This is why we built **NewsPrism**—a revolutionary AI-powered news analysis platform built entirely on **Amazon Web Services (AWS)** and powered by the **Amazon Nova** family of models.
...
### 1. Multi-Agent Orchestration with Amazon Nova
We deployed a four-agent system that operates in parallel:
*   **The Sentinel (Nova Pro)**: Analyzes the article through a right-leaning, market-focused lens.
*   **The Advocate (Nova Pro)**: Analyzes through a left-leaning, equity-focused lens.
*   **The Jurist (Nova Pro)**: A neutral fact-checker that identifies missing context and strips away emotive language.
*   **The Prism Orchestrator (Nova Lite)**: Cross-references the three outputs to calculate a **Polarization Index** and find the "Shared Reality."

### 2. High-Speed Live Debates
Using **Amazon Bedrock’s** high-throughput inference, our agents engage in a live debating session. We chose **Amazon Nova Lite** for the debate logic because its ultra-low latency allows for a fluid, conversational experience that feels human, even when the logic is powered by complex AI.
...
*   **Demonstrates Model Diversity**: It shows how Nova Pro (for deep reasoning) and Nova Lite (for speed) can work together in a single application.
...
**The future of news isn't a monologue; it's a debate. And with Amazon Nova, that debate is finally fair.**
